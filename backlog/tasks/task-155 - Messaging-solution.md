...
Use cases:
1. When crew is approved to a leg, either by AI assessment or manually by the skipper / owner > after approval, skipper and crew can send messages to each other. Messaging feature between skipper / crew is available until the end of the leg
