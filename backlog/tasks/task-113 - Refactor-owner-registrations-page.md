...
Each column is sortable by clicking the header and also per each column there is a filter that can be used to select "all" or a specific value per column.
