---
id: TASK-087
title: Missing email confirmation information
status: To Do
assignee: []
created_date: '2026-02-07 15:42'
labels: []
dependencies: []
---
...
Immediate confirmation message after signup form submission

Persistent email verification banner on the home page until email is confirmed
...
EmailConfirmationModal appears
...
EmailVerificationBanner appears (if not verified)
...
User can still use app (with consent modal)
...
Signup Page: Modify to show modal instead of immediate redirect

Home Page: Add banner component conditionally

Layout Components: Ensure banner appears on all main pages for unverified users

Consent Modal: May need to show after email verification acknowledgment
