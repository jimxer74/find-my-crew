...
## Acceptance criteria
- [ ] Skipper can fill seaworthiness declaration when creating/editing a journey
- [ ] Declaration fields are shown to crew in the leg detail panel under a "Skipper's pre-departure declaration" section
- [ ] AI readiness narrative is generated (or regenerated) when a voyage is published
- [ ] Readiness narrative shown on leg detail panel
- [ ] `miles_on_vessel` and `offshore_passage_experience` fields added to boat profile form and shown on leg detail
- [ ] All new DB columns covered by a migration file and specs/tables.sql updated
