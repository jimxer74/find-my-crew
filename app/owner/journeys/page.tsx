                ...
                .map((journey) => {
                  ...
                  return (
                    <div key={journey.id} className="bg-card rounded-lg shadow p-6 flex flex-col">
                      ...
                      {/* Card Actions */}
                      <div className="flex items-center flex-wrap gap-2 mt-auto pt-4 border-t border-border">
                        {/* Edit Journey */}
                        <Link
                          href={`/owner/journeys/${journey.id}/edit`}
                          className="flex items-center gap-1.5 px-2 py-1.5 text-xs text-muted-foreground hover:text-primary transition-colors rounded hover:bg-accent"
                          title={t('editJourney')}
                        >
                        ...
                        <button
                          ...
                          className="flex items-center gap-1.5 px-2 py-1.5 text-xs text-muted-foreground hover:text-destructive transition-colors rounded hover:bg-destructive/10 ml-auto"
