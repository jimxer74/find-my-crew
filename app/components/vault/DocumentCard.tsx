  ...
  return (
    <div className="bg-card rounded-lg border border-border shadow-sm hover:shadow-md transition-shadow">
      ...
      <div className="flex border-t border-border divide-x divide-border">
        <button
          onClick={() => onView(doc)}
          className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2.5 min-h-[44px] text-xs font-medium text-foreground hover:bg-accent transition-colors"
        >
        ...
        <button
          ...
          className="flex items-center justify-center gap-1.5 px-3 py-2.5 min-h-[44px] text-xs font-medium text-destructive hover:bg-destructive/10 transition-colors"
        >
          <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
