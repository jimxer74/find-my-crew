        ...
        <div className="p-6">
          ...
          <div className="border-t border-border pt-4 mb-6">
            ...
            <button
              ...
              disabled={!canResend()}
              className="w-full py-2 px-4 bg-primary text-primary-foreground rounded-md font-medium disabled:opacity-50 disabled:cursor-not-allowed hover:opacity-90 transition-opacity"
            >
              {canResend() ? (
          ...
          <div className="flex gap-3">
            <button
              onClick={onClose}
              className="flex-1 py-3 px-4 bg-primary text-primary-foreground rounded-md font-medium hover:opacity-90 transition-opacity"
            >
