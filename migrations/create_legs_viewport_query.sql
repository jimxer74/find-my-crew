...
-- Add comment
COMMENT ON FUNCTION get_legs_in_viewport IS 'Returns legs within a viewport for crew browsing. Uses PostGIS bbox for fast spatial queries. Only returns legs from published journeys. Supports optional filters for dates, risk levels, and skills.';
